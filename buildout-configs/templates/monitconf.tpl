...
{% for i in range(1,9) %}
{% with INSTANCE='www'+str(i) %}
{% if parts[INSTANCE]['recipe'] %}
    check process $INSTANCE with pidfile ${parts.buildout['directory']}/var/${INSTANCE}.pid
        start program = "${parts.buildout['bin-directory']}/$INSTANCE start"
        stop program = "${parts.buildout['bin-directory']}/$INSTANCE stop"
{% end %}
{% end %}
{% end %}
