...
* how to email
* [DONE] how to use KGS
* [DONE] how to buildout configs + add more zope instances
* how to pack Data.fs
...
System administrators should configure logrotate for example like this::

    # rotate Apache logs for MY-EEA-PORTAL
    /var/log/apache2/*.log {
    weekly
    missingok
    rotate 52
